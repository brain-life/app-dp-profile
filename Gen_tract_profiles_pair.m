...
if ~strcp(measure,'FA') && mean(Meas_tract1(:)) < 0.01
...
if ~strcp(measure,'FA') && mean(Meas_tract_12(:)) < 0.01
...
if ~strcp(measure,'FA') && mean(Meas_tract2(:)) < 0.01
...
if ~strcp(measure,'FA') && mean(Meas_tract2_12(:)) < 0.01
...
saveas(gcf, strcat('./results/figures/',measure,'/',measure,'_profile_',tract_name1,'_cross.fig'));
saveas(gcf, strcat('./results/figures/',measure,'/',measure,'_profile_',tract_name1,'_cross.pdf'));
saveas(gcf, strcat('./results/figures/',measure,'/',measure,'_profile_',tract_name1,'_cross.png'));
...
saveas(gcf, strcat('./results/figures/',measure,'/',measure,'_profile_',tract_name2,'_cross.fig'));
saveas(gcf, strcat('./results/figures/',measure,'/',measure,'_profile_',tract_name2,'_cross.pdf'));
saveas(gcf, strcat('./results/figures/',measure,'/',measure,'_profile_',tract_name2,'_cross.png'));
