...
if ~strcmp(measure,'FA') && mean(Meas_tract1(:)) < 0.01
...
if ~strcmp(measure,'FA') && mean(Meas_tract2(:)) < 0.01
...
if ~strcmp(measure,'FA') && mean(Meas_tract2_12(:)) < 0.01
