function [] = Gen_tract_profiles_single(info, tract_name, std_parameter, measure, Nnodes)
...
if ~strcmp(measure,'FA') && nanmean(Meas_tract(:)) < 0.01
...
if ~strcmp(measure,'FA') && nanmean(Meas_tract_orig(:)) < 0.01
...
if ~strcmp(measure,'FA') && nanmean(Meas_tract_pred(:)) < 0.01
...
if ~strcmp(measure,'FA') && nanmean(Meas_tract_iso(:)) < 0.01
